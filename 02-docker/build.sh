...
#
# Purpose:
#   Builds the keygen-functions Docker image and pushes it to OCIR.
...
#   OCIR_USERNAME  namespace/user-name
...
IMAGE_PATH="${OCIR_HOST}/${NAMESPACE}/keygen-functions:${IMAGE_TAG}"
